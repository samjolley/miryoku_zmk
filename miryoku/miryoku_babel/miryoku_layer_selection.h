...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_HANDSDOWNGOLD)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_HANDSDOWNGOLD_FLIP
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_HANDSDOWNGOLD_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_ALPHAS_HANDSDOWNGOLD)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_HANDSDOWNGOLD
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_HANDSDOWNGOLD
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_HANDSDOWNGOLD_FLIP)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_HANDSDOWNGOLD_FLIP
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_HANDSDOWNGOLD_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_EXTRA_HANDSDOWNGOLD)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_HANDSDOWNGOLD
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_HANDSDOWNGOLD
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_ALTERNATIVES_TAP_HANDSDOWNGOLD_FLIP)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_HANDSDOWNGOLD_FLIP
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_HANDSDOWNGOLD_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_ALTERNATIVES_TAP_HANDSDOWNGOLD)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_HANDSDOWNGOLD
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_HANDSDOWNGOLD
    #endif
  #endif
