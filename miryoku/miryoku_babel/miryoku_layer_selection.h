...
#include "miryoku_layer_alternatives.h"
    ...
    #if defined (MIRYOKU_ALPHAS_HANDSDOWNGOLD_FLIP)
    ...
    #endif
  #else
    #if defined (MIRYOKU_ALPHAS_HANDSDOWNGOLD)
  ...
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_EXTRA_HANDSDOWNGOLD)
  ...
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_TAP_HANDSDOWNGOLD)
